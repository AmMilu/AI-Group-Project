# -*- coding = utf-8 -*-
# @Time : 06/04/2022 12:11
# @Author : Kiser
# @File : genetic_thief.py
# @Software : PyCharm
import random
import math
...
class Genetic_:
    ...
    def find_path(self, src, dest):
        ...
        routes_ = sorted(self.routes, key=lambda route: self.fitness_score(dest, route), reverse=True)
        ...
        while iteration < self.num_iteration:
            ...
            routes_ = sorted(routes_, key=lambda route: self.fitness_score(dest, route), reverse=True)
